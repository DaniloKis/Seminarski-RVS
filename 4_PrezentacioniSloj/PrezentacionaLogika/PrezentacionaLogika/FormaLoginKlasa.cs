...
namespace PrezentacionaLogika
{
    public class FormaLoginKlasa
    {
        ...
        // vraca ulogu korisnika (kolona Status u tabeli Korisnik): 'Admin' ili 'Kurir'
        public string DajUloguKorisnika()
        {
            string uloga = "";
            ...
            if (PodaciDataSet.Tables[0].Rows.Count > 0)
            {
                uloga = PodaciDataSet.Tables[0].Rows[0].ItemArray[5].ToString();
            }
            return uloga;
        }
